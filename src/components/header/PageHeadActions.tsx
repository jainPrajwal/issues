  ...
  return <div className="wrapper-page-head-actions d-flex gap-10 ai-center ml-auto f-wrap">
    <button className="btn btn-icon d-flex gap-10 ai-center">
      <div className="d-flex gap-10 ai-center">
        ...
        <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" className="octicon octicon-eye">
    ...
    <button className="btn btn-icon d-flex gap-10 ai-center">
      <div className="d-flex gap-10 ai-center">
        ...
        <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16"  className="octicon octicon-star-fill starred-button-icon d-inline-block mr-2">
